export const prodNavLinks = [
  { id: 1, label: "Our team", href: "kautilya-next/about", mainNavItem: true },
  {
    id: 2,
    label: "Academics",
    dropdown: true,
    ...
    dropdownItems: [
      {
        id: 21,
        label: "Kautilya Advantage",
        href: "kautilya-next/study-at-kautilya",
      },
      { id: 22, label: "Faculty", href: "kautilya-next/our-faculty" },
      {
        id: 23,
        ...
        dropdownItems: [
          {
            ...
            href: "kautilya-next/doctoral-ph-d-duration",
          },
          { id: 232, label: "Master’s Program", href: "kautilya-next/mpp" },
        ],
      },
      {
        id: 24,
        label: "Mentorship @ kautilya",
        href: "kautilya-next/mentorship-program",
      },
      {
        id: 25,
        label: "Academic Calendar",
        href: "kautilya-next/academic-calendar",
      },
      { id: 26, label: "Academic FAQS", href: "kautilya-next/academics-faqs" },
    ],
  },
  {
    id: 3,
    ...
    mainNavItem: true,
    dropdownItems: [
      { id: 31, label: "Research Areas", href: "kautilya-next/research" },
      {
        id: 32,
        label: "Grants & Funding",
        href: "kautilya-next/research-projects",
      },
      {
        id: 33,
        label: "Capstone Project",
        href: "kautilya-next/capstone-project",
      },
      { id: 34, label: "Issue brief", href: "kautilya-next/issue-brief" },
      {
        id: 35,
        label: "Publications",
        dropdown: true,
        dropdownItems: [
          { id: 351, label: "Faculties", href: "kautilya-next/publications" },
          {
            id: 352,
            label: "Academic Associates",
            href: "kautilya-next/publications-academic-associates",
          },
        ],
      },
      { id: 36, label: "Research FAQs", href: "kautilya-next/research-faqs" },
    ],
  },
  {
    id: 4,
    ...
    dropdownItems: [
      ...
      //   id: 41,
      //   label: "Virtual Tour",
      //   href: "kautilya-next/campus-virtual-tour",
      // },
      {
        id: 42,
        label: "Student Mix @ Kautilya",
        href: "kautilya-next/student-mix",
      },
      {
        id: 43,
        ...
        dropdownItems: [
          {
            id: 431,
            label: "Ph.D. Program",
            href: "kautilya-next/ph-d-duration",
          },
          {
            id: 432,
            label: "Master’s Program",
            href: "kautilya-next/admission-process",
          },
        ],
      },
      { id: 44, label: "Partnerships", href: "kautilya-next/partnership" },
      {
        id: 45,
        label: "Financial Aid",
        href: "kautilya-next/scholarships-financial-aid",
      },
      {
        id: 46,
        label: "Admissions FAQs",
        href: "kautilya-next/admissions-faqs",
      },
    ],
  },
  {
    ...
    mainNavItem: true,
    dropdownItems: [
      { id: 61, label: "Facilities", href: "kautilya-next/campus" },
      {
        id: 62,
        label: "Alumni Network",
        href: "kautilya-next/alumni-association",
      },
      { id: 63, label: "Student Clubs", href: "kautilya-next/student-clubs" },
      {
        id: 64,
        label: "Resources",
        dropdown: true,
        dropdownItems: [
          { id: 641, label: "Library", href: "kautilya-next/library" },
          { id: 642, label: "blog", href: "kautilya-next/blogs" },
          {
            id: 643,
            label: "Podcast Resource List",
            href: "kautilya-next/resource-list-of-podcasts",
          },
          { id: 644, label: "Events", href: "kautilya-next/resources" },
        ],
      },
      { id: 65, label: "Video Gallery", href: "kautilya-next/videos" },
      {
        id: 66,
        label: "Policies & Guidelines",
        href: "kautilya-next/kspp-policies",
      },
    ],
  },
  {
  ...
  //   id: 7,
  //   label: "Work @ kautilya",
  //   href: "kautilya-next/careers",
  //   mainNavItem: true,
  // },
  // {
  //   id: 8,
  //   label: "Contact",
  //   href: "kautilya-next/contactus",
  //   mainNavItem: true,
  // },
  {
    id: 9,
    label: "Colloquy",
    href: "kautilya-next/kautilya-colloquy-2024",
    mainNavItem: true,
  },
];
