...
function MasterPublicPolicy(){
    return (
        <MainLayout>
            <div className="event4_bg bg-[url('/assets/img/events/publicpolicy/masterMPP.jpg')] bg-center bg-no-repeat bg-cover">
                <section>
                    <div className="container mx-auto">
                    <div className="grid grid-cols-1 xl:grid-cols-12 gap-4">
                        <div className="col-span-12 text-left">
                        <h5 className="mt-5 mb-5 text-4xl font-bold ">
                            The 2-year route to <br/>mastering public policy
                        </h5>
                        </div>
                        ...
                        <div className="ask_me_text mt-24 text-left">
                            ...
                            <span className="text-black bg-white px-2 py-1 inline-block text-lg">Syed Akbaruddin</span><br/>
                            Dean, Kautilya School of Public Policy;<br/>
                            Former Permanent Representative <br/> of India to the UN<br/>
                            </p>
                            <p className="text-white mt-4">
                            <img src="/assets/img/events/publicpolicy/calender_white.png" className="inline-block me-3 mb-2"/>
                            June 1, Thursday<br/>
                            <img src="/assets/img/events/publicpolicy/time_white.png" className="inline-block me-3"/>
                ...
                <section className="section_bg">
                    <div className="container mx-auto">
                        ...
                        <div className="text-center col-span-1">
                            ...
                            professionals who can deliver data-driven, practical solutions to
                            unique challenges in management, administration, compliance, and
                            much more.
                            </p>
                            <p>
                            Join Dean Syed Akbaruddin for an in-depth session on how you can
                            transform these areas of challenge into opportunities. Learn about
                            the international pedagogy and immersive, collaboration-rich
                            curriculum that powers the 2-year Master of Public Policy (MPP)
                            program. Also, learn about the exciting new roles our Class of
                            2023 graduates have secured at leading organizations like Paytm,
                        ...
                        <section className="section_bg">
                            <div className="container mx-auto">
                                ...
                                <div className="col-span-1">
                                    ...
                                    <li>Junior to middle-level professionals looking to transform their careers</li>
