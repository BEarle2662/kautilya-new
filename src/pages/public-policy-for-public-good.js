  ...
  <div className="container mx-auto">
    <div className="grid grid-cols-1">
      <div className="col-span-12 text-center">
        ...
        <p className="text-center mt-4">
          With a shift in government and corporate strategy to boost the economic development along with higher index of the quality life, professionals with expertise in policy making will be most sought after. 
          <strong>The Future is promising for today’s early movers.</strong>
        </p>
        <p className="text-center mt-4">
          Join me in this exclusive session for you to help you understand why the professional program in policy making may suits best to your career aspirations.&nbsp;
            ...
            <div className="grid grid-cols-1">
              ...
              <div className="col-span-12">
                <ul className="entry_content">
                  ...
                  <li>What makes KSPP’s curriculum most unique and effective in career progression?</li>
