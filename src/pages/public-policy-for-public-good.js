...
function PPForPg() {
  return (
    <MainLayout>
      <div className="ppforp bg-pp-for-pgImg bg-center bg-no-repeat bg-cover min-h-[80vh]">
          ...
          <div className="container-fluid">
            <div className="grid grid-cols-12">
              <div className="col-span-3">
                <div className="bg-white rounded-md shadow-[4px_4px_4px_4px_#cd6d786b] px-[40px] py-[35px] text-center hidden">
