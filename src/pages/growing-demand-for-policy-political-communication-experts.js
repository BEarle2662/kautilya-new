...
function PoliticalExperts() {
  return (
    <MainLayout>
        ...
        <div className="grid grid-cols-1">
          <div className="col-span-1">
            <p className="text-right">
              <a className="bg-black text-white p-2">
      ...
      <section className="politicalCE bg-political-bg bg-center bg-no-repeat bg-cover">
        <div className="container mx-auto">
          <div className="grid grid-cols-1">
            <div className="col-span-1">
              <h4 className="text-white mb-4">
                <span className="bg-[#b20016] p-1 text-2xl">
                  Ask Me Anything
                </span>
              </h4>
              <h4 className="text-black mb-4 text-4xl ">
              ...
              <div className="col-span-1">
                <div>
                  <p className="text-white">
                    ...
                    governments, businesses and civil societies have begun to
                    understand that following traditional mechanisms does not
                    seem to bring the development that will solve the economic
                    problems of tomorrow.
                  </p>
                  <p className="text-white mt-4">
                    If you want to solve these 21st-century challenges and in
                    the process build an impactful career in the Government,
                    corporations and Public services sector, a career in public
                    policy can be as promising and dynamic as it sounds. Know
                    all the heights that you can reach in public policy in our
            ...
            <div className="col-span-1">
              ...
              <ul className="entry_content text-white list-disc pl-5">
                <li>
                  ...
                  communications, social sector, and other related fields.
                </li>
                <li>
                  Academicians, researchers, journalists and professionals,
                  analysts, working in or following the fields mentioned above.
                </li>
                <li>
                  Young Indians, passionate about bringing about change in
                  India.
                </li>
              </ul>
            </div>
