...
function UnpackingLaw(){
    return (
        <MainLayout>
            <section className="dataProtection bg-[url('/assets/img/talkseries/talkpolicy/unpacking_bg.jpg')] bg-center bg-no-repeat bg-cover">
                <div className="container mx-auto">
                    <div className="flex flex-col">
                    <div className="m-3 p-3 w-full"></div>
                    <div className="w-full">
                        <div className="top-div text-left">
                        <h4 className="ctext-black text-3xl mb-14">Let’s Talk Policy</h4>
            ...
            <section>
                <div className="container mx-auto">
                    ...
                    <div className="col-span-1">
                        <img src="/assets/img/talkseries/talkpolicy/gupta.png" alt="Image 1" class="max-w-[75%] h-auto align-top" />
                    </div>
                    <div className="col-span-1">
                        <img src="/assets/img/talkseries/talkpolicy/prasanth.png" alt="Image 2" class="max-w-[75%] h-auto align-top" />
                    </div>
                    <div className="col-span-1">
                        <img src="/assets/img/talkseries/talkpolicy/muktesh.png" alt="Image 3" class="max-w-[75%] h-auto align-top"/>
                    </div>
                    <div className="col-span-1">
                        <img src="/assets/img/talkseries/talkpolicy/smita_m.png" alt="Image 4" class="max-w-[75%] h-auto align-top"/>
                    </div>
                    </div>
                </div>
            </section>
            <section className="bg-gray-800 bg-[url('/assets/img/talkseries/talkpolicy/unpacking_middle_bg.jpg')] bg-center bg-no-repeat bg-cover">
                <div className="container mx-auto">
                    ...
                    <div className="col-span-1">
                        ...
                        <p className="text-white">
                            There are debates on whether this bill is an improvement over its previous avatar or if it is attempting to balance national security with global diplomacy and cross-border co-operation.
                        </p>
                        </div>
                    </div>
                    </div>
