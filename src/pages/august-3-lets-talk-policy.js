    ...
    <MainLayout>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-5">
            <div className="mt-5">
              ...
              <p className="LTP-tit text-white text-2xl">
                “How can research and innovationin India be more impactful?”
              </p>
      ...
      <section className="about_evnt">
        <div className="container mx-auto px-4 text-xl">
          ...
          <p>
            India has joined the top 50 countries in the{" "}
            <b>Global Innovation Index (GII, 2020) </b>for the first time,
            moving up four places to the 48th rank, keeping the leading position
            among nations in central and southern Asia.
          </p>
          <p>
            While India has the scientific talent, what stops Indian research
            and innovation from being genuinely impactful? Is it lack of funding
            support, the risk-averse mindset of investors, and lack of an
            enabling ecosystem or the absence of gender/racial parity in
            research?
          </p>
          <p>
            In this <b>Let’s Talk Policy session</b>, we looked at how to beef
            up the national innovation ecosystem with <b>Sridhar Pabbisetty</b>,
            Founding Director, Kautilya School of Public Policy,{" "}
            <b>Saket Modi</b>, CEO &amp; Co-Founder, Safe Security,{" "}
            <b>Ashutosh Sharma</b>, Secretary, Department of Science and
            Technology (DST), Government of India and <b>Dr. Chandrima Shaha</b>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-black p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px] border-4 border-white">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-white text-center">
                  Founding Director, Kautilya{" "}
                </p>
                <p className="text-sm font-medium text-white text-center">
                  -------
                </p>
                <p className="text-sm text-white text-center">
                  Sridhar Pabbisetty has been working in public policy and
            ...
            <div className="bg-[#b2061c] p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-white text-center">
                  Saket Modi is the Co-Founder and CEO of Safe Security, a
            ...
            <div className="bg-black border-4 border-white p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px]">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-white text-center">
                  ...
                  <br />& Tech, Gov. of India
                </p>
                <p className="text-sm font-medium text-white text-center">
                  -----
                </p>
                <p className="text-sm text-white text-center">
                  Ashutosh Sharma is a Secretary to the Government of India
                  since January 2015, heading the …
                </p>
                <p className="text-white text-center">
            ...
            <div className="bg-[#b2061c] p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px]">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-white text-center">
                  Prof. Chandrima Shaha is a biologist and the first ever woman
