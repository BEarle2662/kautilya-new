            ...
            <section className="lets_talk bg-[#b51c21]">
                <div className="container mx-auto">
                    ...
                    <div className="mt-5">
                        ...
                        <p className="LTP-tit text-white text-2xl">“How can research and innovationin India be more impactful?”</p>
                        ...
                        <span className="flex items-center">
                            ...
                            <span className="LTP-tit text-white text-xl ml-3">August 3, 2021</span>
                        </span>
                    ...
                    <div className="mt-5">
                        <img src="/assets/img/talkseries/talkpolicy/LP-top-banner-PNG-1-1.png" alt="Event Banner" />
                    </div>
                    </div>
                </div>
            </section>
            ...
            <section className="panellists bg-[url('/assets/img/talkseries/talkpolicy/november_bg.jpg')] bg-center bg-no-repeat bg-cover">
                <div className="container mx-auto px-4">
                    ...
                    <div className="bg-black p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px] border-4 border-white">
                        ...
                        <p className="text-sm text-white text-center">Sridhar Pabbisetty has been working in public policy and governance over the last decade….</p>
                    ...
                    <div className="bg-[#b2061c] p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px">
                        ...
                        Safe Security</p>
                        <p className="text-sm font-medium text-white text-center">-----</p>
                        <p className="text-sm text-white text-center">Saket Modi is the Co-Founder and CEO of Safe Security, a Cybersecurity and Digital Business …</p>
                        <p className="text-white text-center"><a className="hover:underline text-white text-center" href="#">Read more</a></p>
                        </div>
                    </div>
                    ...
                    <div className="bg-black border-4 border-white p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px]">
                        ...
                        & Tech, Gov. of India</p>
                        <p className="text-sm font-medium text-white text-center">-----</p>
                        <p className="text-sm text-white text-center">Ashutosh Sharma is a Secretary to the Government of India since January 2015, heading the …</p>
                    ...
                    <div className="bg-[#b2061c] p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px]">
                        ...
                        Science Academy</p>
                        <p className="text-sm font-medium text-white text-center">-----</p>
                        <p className="text-sm text-white text-center">Prof. Chandrima Shaha is a biologist and the first ever woman president of the Indian National…</p>
                        <p className="text-white text-center"><a className="hover:underline " href="#">Read more</a></p>
                        </div>
                    </div>
                    </div>
