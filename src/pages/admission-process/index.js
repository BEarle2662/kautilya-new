...
export async function getStaticProps() {
  let  metaComponentResponse = await MetaTagsComponent({ page: "admission-process" });
  if (!metaComponentResponse) {
    console.log("No Meta Data for admission process Page, fetching Home Page Meta Data");
