  ...
  return (
    <div className="admission-process">
          ...
          <div className="overflow-auto mt-4">
            <table className="table-auto border-collapse w-full border border-gray-200">
              <thead className="text-white">
                <tr>
                  <th className="border bg-primary text-center p-2" colSpan="4">
                    Important Dates
                  </th>
                </tr>
                <tr>
      ...
      <div>
        <div className="bg-primary text-white p-1 mt-8">
          <div className="container mx-auto px-4">
            <h3 className="text-lg  font-semibold">Types of Public Policy ?</h3>
          </div>
        </div>
        <div className="container mx-auto px-4">
          <div className="mt-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
            ...
            <div>
              ...
              <p>
                ...
                a Capstone Project (CAP), undertaken either independently with
                an organization or as part of a faculty-led group research
                project on a current policy issue.
              </p>
              <p>
