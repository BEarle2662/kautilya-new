...
function Russia() {
  return (
    <MainLayout>
      <section className="bg-russiaUkrain bg-russia-bg bg-center bg-no-repeat bg-cover">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 gap-5">
            ...
            <div className="col-span-1 text-left font-semibold">
              ...
              <p className="text-2xl text-white mt-8 text-light">
                March 9th, 2022 | 7PM – 8PM
              </p>
            </div>
          </div>
        </div>
      </section>
      <section className="bg-russiaUkrain2 bg-russia-sep bg-center bg-no-repeat bg-cover">
              ...
              <div className="grid grid-cols-1 xl:grid-cols-3 gap-5">
                <div className="text-center">
                  ...
                  <p className="k-eventcard5-desig text-white font-bold">
                    Fmr. Permanent Rep. of India to the UN; Dean, Kautilya
                  </p>
                </div>
                <div className="text-center">
                  <img
                  ...
                  <p className="k-eventcard5-desig text-white font-bold">
                    (IFS:1988), recently retired Indian Ambassador to Russia;
                    Lectures occasionally at Kautilya
                  </p>
                </div>
                <div className="text-center">
                  <img
                  ...
                  <p className="k-eventcard5-desig text-white font-bold">
                    Project Director at Ekatrit – Educate Girls;
                    <br /> Co-Founder, Kautilya
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1">
            <div className="col-span-1 mb-4">
              <h5 className="text-primary text-lg">
                Listen to India's former UN representative and India's former
                Ambassador to the Russian Federation discuss:
              </h5>
            </div>
            <div className="col-span-1">
              <ul className="entry_content">
                <li>
                  Background and history of the current crisis in Ukraine.
                </li>
                ...
                <li>
                  What should India’s stand at the UN Security Council be?
                </li>
      ...
      <section className="bg-russiaUkrain3 bg-russia-footer bg-center bg-no-repeat bg-cover">
        <div className="container mx-auto">
          <div className="grid grid-cols-1">
            ...
            <div className="col-span-1">
              <ul className="entry_content text-white">
                <li>
                  Those keen in public life, public policy &amp; administration,
                  international relations governance, media, journalism &amp;
                  communications, politics, and other related fields.
                </li>
                <li>
                  Those wanting to pursue careers in international
                  organizations.
                </li>
                <li>
                  Those seeking clarity on what information to absorb &amp; how
                  to process it with respect to the current situation in
                  Ukraine.
                </li>
                <li>
                ...
                <li>
                  Young Indians who are keen to understand how geo-politics
                  plays out and desire to bring about change.
                </li>
              </ul>
            </div>
          </div>
