...
function NuclearDeal(){
    return (
        <MainLayout>
            <div className="nuclearDealtoTech bg-[url('/assets/img/talkseries/talkpolicy/talk_policy_bg.jpg')] bg-center bg-no-repeat bg-cover">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-1 gap-4">
                        ...
                        <p className="LTP-tit text-3xl font-semibold text-white">
                            From Nuclear Deal<br /> to Critical Tech
                        </p>
                        ...
                        <div className="ltp-event mt-12">
                            ...
                            <img className="mb-2.5 w-[30px] mr-2" src="/assets/img/talkseries/talkpolicy/calender_white.png" alt="Calendar" />
                            <span className="font-semibold text-lg">July 27, Thursday</span>
                            </div>
                            <div className="LTP eventicon flex items-center space-x-2 mt-2">
                            <img className="mb-2.5 w-[30px] mr-2" src="/assets/img/talkseries/talkpolicy/time_white.png" alt="Time" />
                            <span className="font-semibold text-lg">
                                7:00 PM – 8:00 PM IST 
                                9:30 AM – 10:30 AM EST (via Zoom)
                            </span>
                            </div>
                        </div>
                        </div>
                ...
                <section>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="col-span-1">
                            ...
                            alt="Lisa" className="max-w-[75%] h-auto align-top"
                            />
                        </div>
                        ...
                        <div className="col-span-1">
                            ...
                            alt="Navtej" className="max-w-[75%] h-auto align-top"
                            />
                        </div>
                        ...
                        <div className="col-span-1">
                            ...
                            alt="Smita" className="max-w-[75%] h-auto align-top"
                            />
                        </div>
                        </div>
                    </div>
