    ...
    <MainLayout>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-5">
            <div className="mt-5">
              ...
              <p className="LTP-tit text-white text-2xl">
                Should India do business with the Taliban?What’s at stake for
                India?
              </p>
      ...
      <section className="about_evnt">
        <div className="container mx-auto px-4 text-xl">
          ...
          <p>
            Taliban’s swift takeover of Afghanistan shocked the world. For
            India, the house-of-cards collapse of the 20-year-old Afghan
            democracy represents a strategic setback.{" "}
          </p>
          <p>
            Does this mean an end of trade relations with Afghanistan, a
            critical strategic ally for India in South Asia? The Indian
            government has made significant investments in the war-torn country
            over the past two decades and provided the government with
            much-needed developmental assistance in terms of investments and
            bilateral trade. The Taliban seizing control in Afghanistan presents
            a bleak future for such projects in Afghanistan. Moreover, India has
            not had a working relationship with the Taliban in the past.{" "}
          </p>

          <p>
            <b>
              While India is currently following the ‘wait and watch’ approach,
              the bigger question is whether India should engage with the
              Taliban now?
            </b>
          </p>
          <p>
            Hear all about it from our expert panellists in this{" "}
            <b>Let’s Talk Policy</b> session – Navtej Sarna, Former Diplomat &
            Author, <b>Suhasini Haider,</b> Diplomatic Affair Editor, The Hindu,{" "}
            <b>Amitabh Mattoo, </b>Professor of International Relations at JNU &
            University of Melbourne and <b> Dr. Shanthie Mariet D’Souza,</b>{" "}
      ...
      <section className="yellow_bg bg-[#ffaf00]">
        <div className="container mx-auto px-4 text-xl">
          <p>
            <span className="font-semibold text-[#b51c21]">
              ‘Let’s Talk Policy’
            </span>{" "}
            <b>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-black p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px] border-4 border-white">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-white text-center">
                  Navtej Singh Sarna diplomatic appointment was as India’s
                  Ambassador to the …
                </p>
                <p className="text-white text-center">
                  <a
            ...
            <div className="bg-[#b2061c] p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-white text-center">
                  Suhasini Haidar has previously served as the Foreign Affairs
                  editor and prime time anchor for …
                </p>
                <p className="text-white text-center">
                  <a
                    className="hover:underline text-white text-center"
            ...
            <div className="bg-black border-4 border-white p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px]">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-white text-center">
                  Prof., Int’l Relations
                  <br />
                  JNU & Univ of Melbourne
                </p>
                <p className="text-sm font-medium text-white text-center">
                  -----
                </p>
                <p className="text-sm text-white text-center">
                  Amitabh Mattoo former Vice Chancellor of University of Jammu,
            ...
            <div className="bg-[#b2061c] p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px]">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-white text-center">
                  Dr. Shanthie Mariet D’Souza is Founder of Mantraya; Visiting
                  Faculty at the Naval War …
                </p>
                <p className="text-white text-center">
                  <a className="hover:underline " href="#">
                    Read more
