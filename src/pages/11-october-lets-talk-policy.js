  ...
  return (
    <MainLayout>
          ...
          <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="mt-5">
              ...
              <p className="LTP-tit text-white text-2xl">
                New W.H.O norms on Air Quality
              </p>
              <p className="LTP-tit text-white text-2xl">
      ...
      <section className="about_evnt bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          <p className="text-base text-gray-700 mb-4">
            ...
            estimated to cause 7 million premature deaths globally every year!
            It further elaborates that almost all of the global population (99%)
            breathes air that exceeds WHO guideline limits. Further, the
            combined effects of ambient (outdoor) and household air pollution
            have increased mortality rates from stroke, heart disease, chronic
            obstructive pulmonary disease, lung cancer, and acute respiratory
            infections.
          </p>
          <p className="text-base text-gray-700 mb-4">
            In a bid to support countries to address air pollution, WHO has
            recently released stringent air quality guidelines, lowering the
            recommended levels of pollutants that can be considered safe for
            human health. The new guidelines recommend new air quality levels to
            protect the health of populations by reducing levels of key air
            pollutants, some of which also contribute to climate change. The
            goal of the guideline is for all countries to achieve recommended
            air quality levels, but the reality is far-fetched.
          </p>
          <p className="text-base text-gray-700 font-bold mb-4">
            Will all countries and regions struggling with high air pollution
            levels be able to adapt to these guidelines?
          </p>
          <p className="text-base text-gray-700 mb-4">
            In this Let’s Talk Policy session, we catch up with
            environmentalists <b>Anumita Roy Chowdhury</b>, Executive Director,
            Research and Advocacy, Centre for Science &amp; Environment;{" "}
            <b>Jyoti Pande Lavakare</b>, Co-founder, Care for Air; and{" "}
            <b>Bhargav Krishna</b>, Fellow, Centre for Policy Research to
            understand how different regions will be impacted.
          </p>
          <p className="text-base text-gray-700 mb-4">
      ...
      <section className="yellow_bg bg-[#ffaf00]">
        <div className="container mx-auto px-4">
          <p className="text-base text-gray-800 mb-4 md:text-xl">
            <span className="font-bold text-[#b51c21]">
              ‘Let’s Talk Policy’
            </span>{" "}
            <b>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-[#b2061c] p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px]">
              ...
              <div className="p-4 text-white text-center">
                ...
                <p className="text-sm font-medium text-black text-center bg-white inline-block p-2 text-lg font-medium">
                  Moderator
                </p>
                <p className="text-sm text-gray-600 text-white text-center text-lg">
            ...
            <div className="bg-black p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px] border-4 border-white">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-white text-center">
                  Exec Dir., Research and Advocacy,
                  <br />
                  Center for Science &amp; Env.
                </p>
                <p className="text-sm font-medium text-white text-center">
                  -------
                </p>
                <p className="text-sm text-white text-center">
                  Anumita Roy Chowdhury is the Executive Director, Research and
                  Advocacy, at the Center for…
                </p>
                <p className="text-white text-center">
                  <a
            ...
            <div className="bg-black p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px] border-4 border-white">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-white text-center">
                  Jyoti Pande Lavakare is a columnist, financial journalist and
                  writer who has lived and worked….
                </p>
                <p className="text-white text-center">
                  <a
                    className="hover:underline text-white text-center"
            ...
            <div className="bg-[#b2061c] p-4 rounded-lg shadow-lg relative ml-[30px] mt-[150px] pb-0 pl-[20px] pr-[20px]">
              ...
              <div className="p-4 text-center">
                ...
                <p className="text-sm text-white text-center">
                  Bhargav Krishna is a Fellow at the Centre for Policy Research.
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <p className="text-white text-3xl text-center">
              Sign-up for this exclusive panel discussion TODAY.
              <br />
              Hear fresh perspectives from some of India’s most revered
              personalities!
            </p>
          </div>
        </div>
