...
function MppApplication() {
  return (
    <MainLayout>
      <div className="bg-gray-800 bg-mpp-application bg-center bg-no-repeat bg-cover min-h-[40vh] py-[70px]">
        <section>
          <div className="container mx-auto">
            <div className="grid grid-cols-1">
              <div className="col-span-1">
                <h5 className="text-black text-left text-xl mb-8">
                  Strengthen your MPP application
                  <br />
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1">
            <div className="col-span-1">
              ...
              <p className="mb-4">
                The study of public policy is a multidisciplinary pursuit that
                requires, above all, the dedication to drive change. A passion
                for solving problems and a data-driven approach hold more weight
                than the traditional markers of educational background and
                professional experience. As such, the question of what makes the
                “perfect” candidate has no specific answer.
              </p>
              <p>
                Join our Dean, Syed Akbaruddin, for insights into the qualities,
                skills, and aptitude that drive policymakers. Get a unique
                perspective on what we look for in applicants for the 2-year
