          ...
          <div className="grid grid-cols-1">
            <div className="col-span-1">
              <h5 className="text-2xl font-semibold">
                Emerging opportunities <br /> in public policy
              </h5>
            </div>
          </div>
          <div className="mt-5 grid grid-cols-1 md:grid-cols-12 gap-4">
            <div className="col-span-1 md:col-span-2">
              <img src={ImagePaths.emerging} alt="Emerging Opportunities" />
            </div>
            <div className="col-span-1 md:col-span-9">
              <div className="text_emerging">
                ...
                <p>
                  on public policy careers with
                  <br />
                  <span className="name_text font-semibold">
                    Prateek Kanwal
                  </span>
                  <br />
                  Co-Founder, Kautilya School
                  <br />
                  of Public Policy
                </p>
              </div>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1">
            <div className="col-span-1 text-bold">
              <p>
                The socioeconomic problems of today require expertise in
                disciplines such as econometrics, design thinking, public
                administration, and trade policy – to name a few. Businesses and
                governments are actively scoping for subject matter experts to
                build accountability and spearhead growth. Specialists who can
                struggle the legislation, commerce, people, and development
                disciplines are crucial to the nation’s growth trajectory.
              </p>
              <p className="mt-4">
                Join our Co-Founder Prateek Kanwal for an Ask Me Anything
                session on how you can start acquiring the skill sets and
                industry competencies to steer progress the right way. Mr.
                Kanwal’s decades-long journey can serve as a great diving board
                for young Indians passionate about driving waves of change
                globally.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1">
            ...
            <div className="col-span-1">
              <ul className="entry_content">
                ...
                <li>
                  Academicians, researchers, and other professionals in relevant
                  sectors
                </li>
