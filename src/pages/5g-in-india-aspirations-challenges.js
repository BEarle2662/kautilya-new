...
function IndiaAspirations(){
    return (
        <MainLayout>
            <div className="challange5g bg-[url('/assets/img/talkseries/talkpolicy/5g_bg.jpg')] bg-center bg-no-repeat bg-cover">
            ...
            <section>
                <div className="social_icons container mx-auto">
                    ...
                    <div className="flex-1">
                        <img src="/assets/img/talkseries/talkpolicy/social_twitter.png" alt="Social Icon 1" />
                    </div>
                    <div className="flex-1">
                        <img src="/assets/img/talkseries/talkpolicy/social_facebook.png" alt="Social Icon 2" />
                    </div>
                    <div className="flex-1">
                        <img src="/assets/img/talkseries/talkpolicy/social_youtube.jpg" alt="Social Icon 3" />
                    </div>
                    </div>
                </div>
            </section>
            <section className="challange5g2 bg-[url('/assets/img/talkseries/talkpolicy/5g_spe_bg.jpg')] bg-center bg-no-repeat bg-cover">
            ...
            <section>
                <div className="container mx-auto">
                    ...
                    <div className="col-span-1">
                        ...
                        <p className="text-lg text-gray-700 mb-4">
                        This Let’s Talk Policy will see our experts discuss the potential of 5G technology and multiple challenges involved in the rollout related to privacy, security, legislation, infrastructure, monetisation, traffic management, and sensing. Listen in to insights on how these challenges can be tackled.
                        </p>
                    </div>
                    </div>
                </div>
