        ...
        <MainLayout>
            <section className="lets_talk oct_talk bg-[url('/assets/img/talkseries/talkpolicy/november_bg.jpg')] bg-center bg-no-repeat bg-cover">
                <div className="container mx-auto">
                    ...
                    <div className="mt-5">
                        ...
                        <span>
                            <img src="/assets/img/talkseries/talkpolicy/quote_red.png" alt="Quote Icon" />
                        </span>
                        ...
                        <p className="LTP-tit text-white text-2xl">INDIA’S CYBER SECURITY CHALLENGE: HOW CAN WE FIGHT BACK?</p>
                        <div className="flex space-x-4 mb-5">
                        <span className="flex items-center">
                            <img src="/assets/img/talkseries/talkpolicy/calender_white.png" alt="Date Icon" />
                            <span className="LTP-tit ml-2 text-white text-xl">November 25th, 2021</span>
                        </span>
                        <span className="flex items-center">
                            <img src="/assets/img/talkseries/talkpolicy/time_white.png" alt="Time Icon" />
                            <span className="LTP-tit ml-2 text-white text-xl">7 – 8PM IST</span>
                        </span>
                        </div>
                    </div>
                    </div>
            ...
            <section className="lets_talk modarate penalist bg-[#b51c21]">
                <div className="container mx-auto text-white">
                    ...
                    <div className="flex items-start">
                        ...
                        <p className="text-white">Visiting Faculty, Kautilya<br />Former Executive Editor, NDTV</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start">
                        ...
                        <p className="text-white">Co-Founder, Centre for Internet &amp;<br />Society Affiliated Fellow – Yale Law<br />School’s Information Society Project</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start mb-3">
                        ...
                        <p className="text-white">Director, Voyager Infosec <br />Consortium</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start mb-3">
                        ...
                        <p className="text-white">Associate Fellow, Centre for Security<br />Strategy and Technology, ORF</p>
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <section className="attendees bg-[url('/assets/img/talkseries/talkpolicy/november_footer_bg.jpg')] bg-center bg-no-repeat bg-cover">
                <div className="container mx-auto px-4">
                    ...
                    <p className="mb-2 text-white">Young Indians, passionate about bringing about positive change and building India.</p>
                    <p className="mb-2 text-white">Those aspiring to build a career in public life, public policy and administration, social sector, media, journalism and communications, politics, and other related fields.</p>
                    <p className="mb-2 text-white">Academicians, researchers, and journalists working in or following the fields mentioned above.</p>
                    <p className="mb-4 text-white">Those watching the unfolding Afghanistan crisis closely – and are keen to hear from experts with relevant experience at the highest level.</p>
                </div>
                ...
                <section className="bg-black text-white">
                    ...
                    <p className="mb-4 text-white">
                        ...
                        <b> is a panel discussion series initiated by Kautilya School of Public Policy</b>, 
                        that brings forth a select group of panellists, sharing differing views on key issues of national and global relevance, and building the dialogue into a conversation for the student community.
                    </p>
                    <p className="text-white">
                        The series aims to unravel major themes around democracy, politics, and human rights, and explore the challenges and rewards of implementing practices. 
                        We aim to create a cohesive platform and call on thematic experts to foster a healthy dialogue around the most pressing issues.
                    </p>
                    </div>
                </section>
                </section>
