...
function PolicyMakingForNewIndia() {
  return (
    <MainLayout>
      <div className="bg-gray-100 bg-policy-Making bg-center bg-no-repeat bg-cover">
        <section>
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              <div className="col-span-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                  ...
                  <div className="col-span-7 mt-5">
                    <p className="text-[#b71016] text-[25px] font-bold">
                      Syed Akbaruddin
                    </p>
              ...
              <div className="col-span-5">
                <div className="bg-white p-8 rounded shadow-md hidden">
                  <form>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1">
            <div className="col-span-1">
              ...
              <p className="mb-4">
                Ideation on a journey to evidence-based #research for
                policymaking is vital to building well-informed, robust policies
                that address our nation’s needs. We need to translate ideas into
                measurable outcomes to drive tangible #impact and positive
                change.
              </p>
              <p>
                Together, let’s embark on this journey of #policymaking, from
                ideation to impact, to build a resilient and thriving New India.
                #PolicyForProgress #NewIndiaJourney
              </p>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="container mx-auto">
          <div className="grid grid-cols-1">
            <div className="col-span-1">
              <h4 className="text-2xl font-semibold pseudo_border mb-3">
                WHO SHOULD ATTEND?
              </h4>
      ...
      <section className="bg-gray-100">
        <div className="container mx-auto">
          <div className="grid grid-cols-1">
            ...
            <div className="col-span-1">
              <p className="italic">
                Join us in this high-value session to learn from the man himself
                who shaped global narratives and served India in a decades-long
                career at the global stage in public service.
              </p>
            </div>
          </div>
        </div>
