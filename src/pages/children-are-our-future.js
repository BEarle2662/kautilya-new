...
function ChildrensFuture(){
    return (
        <MainLayout>
             <div className="children_future_bg bg-[url('/assets/img/events/publicpolicy/children_bg.jpg')] bg-no-repeat bg-cover">
                {/* First Section */}
                <section>
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-1 p-5">
                        ...
                        <div className="mb-[2.25rem] w-full">
                            <p className="text-white text-3xl mb-5">
                                Let’s Talk<br /><span className="font-bold">Policy</span>
                            </p>
                        </div>
                        
                        <div className="col-span-1">
                        <p className="text-white text-4xl mb-16">
                            <span className="font-bold">Children are our Future:</span><br/>
                            <span className="text-2xl">A post-pandemic view of educational<br />opportunities and challenges in India</span>
                        </p>
                        <p className="mt-4 text-white mb-5">
                            <span className="flex items-center text-lg mb-3">
                            <img className="w-6" src="/assets/img/events/publicpolicy/calender_white.png" alt="Calendar Icon" />
                            <span className="ml-2 font-semibold">September 27, Wednesday</span>
                            </span>
                            <span className="flex items-center mt-2 text-lg">
                            <img className="w-6" src="/assets/img/events/publicpolicy/time_white.png" alt="Time Icon" />
                            <span className="ml-2 font-semibold">7:30 PM – 8:30 PM (Via Zoom)</span>
                            </span>
                        </p>
                        <p className="mt-4">
                            <a
                ...
                <section>
                    <div className="container mx-auto">
                        ...
                        <div className="col-span-1">
                            <h4 className="pseudo_border mb-4">WHAT THE SESSION WILL ADDRESS</h4>
